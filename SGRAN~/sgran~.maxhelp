...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 158.0, 297.0, 60.0, 22.0 ],
					"text" : "mc.*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 321.0, 358.0, 74.0, 22.0 ],
					"text" : "mc.unpack~"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 93.0, 311.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 93.0, 229.0, 60.0, 22.0 ],
					"text" : "mc.pack~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 275.0, 411.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.0, 141.0, 79.0, 22.0 ],
					"text" : "pan 0 0.5 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 79.0, 28.0, 51.0, 22.0 ],
					"text" : "hanning"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 42.0, 31.0, 22.0 ],
					"text" : "sine"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-29" : [ "mc.live.gain~", "mc.live.gain~", 0 ],
			"parameterbanks" : 			{
